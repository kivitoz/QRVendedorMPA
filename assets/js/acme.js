...
// Busca los comentarios que dicen: REVISA AQUÍ:(Ok)
...
$(document).ready(function() {
            ...
            case "Mercado Pago": // Método de pago de Mercado Pago
                ...
                $.get("api/pos/get/index.php", { "external_id": external_id }, function(data) {
                    ...
                    if (data.paging.total > 0) {
                        ...
                        $.post("api/order/create/index.php", { "external_id": external_id, "json": JSON.stringify(orderJSON) }, function(data) {
                            ...
                            checkStatus = setInterval(function() {
                                ...
                                $.get("api/notifications/get/index.php", {}, function(data) {
                ...
                modal.find(".btn-primary").on("click", function() { // Cancela la orden
                    ...
                    $.get("api/order/delete/index.php", { "external_id": external_id }, function() {
    ...
    $('#createPOS').click(function() {
        ...
        console.log(posJSON);
        $.post("api/pos/create/index.php", { json: JSON.stringify(posJSON) }, function(results) {
